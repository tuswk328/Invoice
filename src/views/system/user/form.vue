...
export default {
  ...
  data() {
    ...
    return {
      dialog: false, loading: false, form: { username: '', email: '', enabled: 'false', roles: [], job: { id: '' }, dept: { id: '' }, phone: null,nickName:'' },
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.jobId = null
      this.roleIds = []
      this.form = { username: '', email: '', enabled: 'false', roles: [], job: { id: '' }, dept: { id: '' }, phone: null,nickName:'' }
    },
    getRoles() {
      getAll().then(res => {
        this.roles = res
